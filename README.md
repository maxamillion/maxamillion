...
I have a long history of contributing to open source including, but not limited to, projects such as [Fedora](https://fedoraproject.org/) [[1](https://badges.fedoraproject.org/user/maxamillion)], [Ansible](https://github.com/ansible/ansible), [CentOS](https://centos.org/), and [Ramalama](https://github.com/containers/ramalama). I was previously the Chair of the [Linux Founation AI & Data](https://lfaidata.foundation/) [Technical Advisory Council (TAC)](https://lfaidata.foundation/technical-advisory-council/).
